...
void AFMotorLegacyWrapper::encoderISR0() { encoderCount[0]++; }
void AFMotorLegacyWrapper::encoderISR1() { encoderCount[1]++; }
void AFMotorLegacyWrapper::encoderISR2() { encoderCount[2]++; }
void AFMotorLegacyWrapper::encoderISR3() { encoderCount[3]++; }
